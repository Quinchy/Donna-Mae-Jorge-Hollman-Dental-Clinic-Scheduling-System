...
<div class="main-container">
    <div class="about-title-section-container">
        ...
        <div class="line" data-aos="fade-down" data-aos-offset="100" data-aos-duration="1500"></div>
    </div>
    <div data-aos="fade-down" data-aos-offset="100" data-aos-duration="1500" class="about-first-section-container">
        <h1 class="first-section-title">Set aside your concerns upon entering and embrace a more accurate and healthier smile.</h1>
        <p data-aos="fade-down" data-aos-offset="100" data-aos-duration="1500" class="first-section-subtitle">We exclusively select top-tier materials available in the market, ensuring our products meet the highest standards. Our commitment is to offer our patients nothing but the best. Rest assured, you're in good hands with us. Therefore, feel free to book an appointment without any concerns.</p>
        <a class="book-appointment-link" href="{{ route('book-appointment')}}">BOOK AN APPOINTMENT</a>
    </div>
    <div class="about-second-section-container">
        <img data-aos="flip-left" data-aos-offset="100" data-aos-duration="2500" src="{{ asset('img/AboutTeethDecor.png')}}" alt="">
        <h1 data-aos="fade-down" data-aos-offset="100" data-aos-duration="1500" class="second-section-title">Expert care gained through experience.</h1>
        <p data-aos="fade-down" data-aos-offset="100" data-aos-duration="1500" class="second-section-subtitle">At our clinic, years of experience have refined our specialized care, guaranteeing expert focus on each smile for peak dental health. This depth of knowledge ensures every patient receives the utmost attention. We are committed to maintaining and enhancing the health and beauty of every smile that comes through our doors.</p>
    </div>
    <div data-aos="fade-down" data-aos-offset="200" data-aos-duration="1500" class="about-card-section-container">
        <div class="card-container">
            <div data-aos="flip-left" data-aos-offset="100" data-aos-duration="2500" class="about-card">
