<nav class="navbar">
    <div class="navigation-left">
        <a href="https://www.facebook.com/profile.php?id=100076185674873" target="_blank" class="facebook-icon">
            <img src="{{ asset('img/Facebook-Logo.svg') }}" alt="Facebook Icon" class="facebook-icon-normal" />
            <img src="{{ asset('img/Facebook-Logo-Hover.svg') }}" alt="Facebook Icon Hover" class="facebook-icon-hover" />
        </a>
        <a href="{{ route('index') }}" class="nav-link {{ Request::routeIs('index') ? 'active' : '' }}">Home</a>
        @if(Auth::check())
            <a href="{{ route('account') }}" class="nav-link {{ Request::routeIs('account') || Request::routeIs('my-appointment') ? 'active' : '' }}">Account</a>
        @else
            <a href="{{ route('login') }}" class="nav-link {{ Request::routeIs('login') ? 'active' : '' }}">Login</a>
        @endif
    </div>
    <div class="website-logo">
        <img class="logo" src="{{ asset('img/Website-Logo.png') }}" alt="Website Logo" />
...
<link href="{{ asset('css/user/layouts/navigation-bar.css') }}" rel="stylesheet">
